time python ../../python/main.py --num_epochs 2 -i /ceph/users/atuna/work/gavin_tc_dnn/data/pls_t5_embed_0p75_pLSdeltaPhiChargeXYZ_event_2000.root --use_pls_qoverpt | tee log.txt
